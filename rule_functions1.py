...
'''
how tthe input list is organized [author, title, journal, volume, issue, pagina, jaar, month, ISSN, XP, DOI]
Here we define all different rules to get similarity scores
----------
First part of every rule is by setting the parameters
Second part is calculating the score
----------
Returns a score for similarity based on that rule
'''
